...
Personal: `zr |.| gntn |@| gmail (.) com` <br>
Academic: `zhean_robby_ganituen |@| dlsu |.| edu |.| ph` <br>
Personal Website and Blog: [`zrygan.github.io`](https://zrygan.github.io/)  

I am particularly interested in **theoretical computer science**. <br>
My previous projects are on programming languages, machine learning (and theory), and formal grammars. <br>
I primarily use Rust, Go, Python, and Ocaml. <br>
...
- [pho](https://github.com/Mango-Cats/walter/)
